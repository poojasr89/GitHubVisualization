...
men = data[(data.STATUS == 'Complete')]['FORMAL.EDUCATION']

parents_of_men = data[(data.STATUS == 'Complete')]['PARENTS.FORMAL.EDUCATION']
...
axes.bar(ind - width/2, height = means2, width = width, color = 'purple', label = "Surveyors' Parents")

axes.bar(ind + width/2, height = means1, width = width, color = 'IndianRed', label = 'Surveyors')
